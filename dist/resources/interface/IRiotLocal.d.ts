declare type IRiotLocal_Lockfile_Protocol = 'http' | 'https';
...
declare type IRiotLocal_Replace_Where = 'url' | 'body';
interface IRiotLocal_Replace {
    name: string;
    with: string;
    where: IRiotLocal_Replace_Where;
}
declare type IRiotLocal_JSON_Method = 'get' | 'post' | 'patch' | 'put' | 'delete';
...
export type { IRiotLocal_Lockfile_Protocol, IRiotLocal_Lockfile, IRiotLocal, IRiotLocal_Resources, IRiotLocal_Replace_Where, IRiotLocal_Replace, IRiotLocal_JSON_Method, IRiotLocal_JSON };
