...
class Crosshair {
    ...
    toJSON() {
        ...
        if (myCode.P) {
            ...
            // Out Line
            if (myCode.P.h && myCode.P.h === 0) { // h:0 = disable
            ...
            // Center Dot
            if (myCode.P.d && myCode.P.d === 1) { // d:1 = enable
        ...
        if (myCode.A) {
            ...
            if (myCode.A.h && myCode.A.h === 0) { // h:0 = disable
            ...
            if (myCode.A.d && myCode.A.d === 1) { // d:1 = enable
